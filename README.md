...
## Algorithm
1. Import the required libraries and create the student placement dataset.
2. Split the data into features and target, then divide it into training and testing sets.
3. Apply feature scaling and train the Logistic Regression model.
4. Make predictions, evaluate the model, and predict placement status for a new student.
...
## Output:
<img width="1426" height="625" alt="image" src="https://github.com/user-attachments/assets/d1be4756-86cf-4c46-b9ac-f41bac1217ed" />
